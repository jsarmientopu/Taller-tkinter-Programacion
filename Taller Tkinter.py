...
def init_window():
    ...
    label_rad2 = tk.Label(window, text='Si no quiere agregar número seleccione continuar', font=('Arial bold',8))
    label_rad2.grid(column=1,row=4, columnspan=2)
    ...
    label_binario= tk.Label(text='Selccine la opcion binario para ver el resultado en base 2', font=('Arial bold',9))
    ...
    label_resultado2 = tk.Label(window, text='Resultado en binario: ', font=('Arial bold', 15))
    label_resultado2.grid(column=0, row=11)
